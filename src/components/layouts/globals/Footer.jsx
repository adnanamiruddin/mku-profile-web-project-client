...
export default function Footer() {
  return (
    <footer className="-m-2 bg-[#333333] text-white py-8 px-5 md:px-24 md:py-16">
      ...
      <div className="flex flex-col md:flex-row md:items-start md:gap-40">
        <div className="mt-10 text-sm flex items-start w-full md:w-[60%]">
          <div className="w-1/2 flex flex-col gap-1 md:w-[33%]">
          ...
          {/*  */}
          <div className="hidden md:flex flex-col gap-1 md:w-[33%]">
        ...
        <div className="md:hidden mt-10 flex flex-col gap-1">
          <h4 className="font-semibold mb-1">INFORMASI</h4>
          <p>Peta MKU</p>
          <p>Berita</p>
        </div>

        <div className="mt-10 flex flex-col gap-1 md:w-[40%] md:text-sm">
